...
<section class="mb-4" style="width: 70%;margin-left: 5%;margin-top: 5%;">
    <h2 class="h1-responsive font-weight-bold my-4" style="color: #838391;">Search Books by Category</h2>
	<h4>Specify a Book Id to retrieve the book details. Book Id  must be available in the Catalog</h4>
	<h4>Example bookid values are b001,b002 </h4>
    <div class="row">
        <div class="col-md-9 mb-md-0 mb-5">
            <form action="RestServlet1">
				 <div class="row">
                    <div class="col-md-6">
                        <div class="md-form mb-0">
                            <input type="text" id="bookid" name="bookid" value="b001" class="form-control"></input>
